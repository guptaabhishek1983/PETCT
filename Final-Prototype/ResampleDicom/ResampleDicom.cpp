//#define RESAMPLE_DICOM 1

#ifdef RESAMPLE_DICOM
// ResampleDicom.cpp : Defines the entry point for the console application.
//
...
int main(int argc, char** argv)
{
	...
	const std::string ImageFile = "D:\\DicomDataSet\\PTCT\\Dataset1\\PT.jpeg";
	...
	translation1[0] = -50;
	translation1[1] = -50;
	const double scale[Dimension] = { 2.0, 2.0 };
	...
	writer->SetFileName("D:\\DicomDataSet\\PTCT\\Dataset1\\PT_resampled.jpeg");
